...
export default function DoctorPrescriptionDetailPage() {
  ...
  useEffect(() => {
    ...
    const fetchPrescription = async () => {
      try {
        const response = await fetch(`${apiBase}/api/doctor/prescriptions/${prescriptionId}`, {
    ...
    return (
      <div className="min-h-screen bg-slate-950 px-6 py-8">
        <div className="max-w-4xl mx-auto">
          <Link href="/doctor/prescriptions" className="text-cyan-400 hover:text-cyan-300 text-sm mb-8 inline-block">
  ...
  return (
    <div className="min-h-screen bg-slate-950 px-6 py-8">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <Link href="/doctor/prescriptions" className="text-cyan-400 hover:text-cyan-300 text-sm mb-4 inline-block">
            ← Back to Prescriptions
          </Link>
        ...
        <div className="rounded-2xl border border-cyan-500/20 bg-cyan-500/5 p-8 mb-8 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div>
              <p className="text-sm text-slate-400 mb-2">User</p>
              <p className="text-lg font-semibold text-slate-100">@{prescription.uploaded_by}</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-4 mb-8">
          ...
          <Link href={`/doctor/patient/${prescription.user_id}/prescriptions`} className="flex-1">
            <button className="w-full px-6 py-3 rounded-full bg-purple-500 text-slate-950 font-semibold hover:bg-purple-400 transition">
